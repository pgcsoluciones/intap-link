...
const MEDIA: MediaItem[] = [
  { name: 'Mes de la Belleza', title: { es: 'Campaña retail y presencia de marca', en: 'Retail campaign and brand presence' }, image: '/assets/adonisg/media/appearance-01.webp' },
  { name: 'DMH · DLB Noticias', title: { es: 'Lo Que No Te Cuentan del Éxito', en: 'Lo Que No Te Cuentan del Éxito' }, image: '/assets/adonisg/media/appearance-02.webp' },
  { name: 'Gran Bazar de Emprendedores', title: { es: 'Potencializa tu imagen en redes sociales', en: 'Elevate your image on social media' }, image: '/assets/adonisg/media/appearance-03.webp' },
  { name: 'Fashion Freak Fest', title: { es: 'Presencia en Fashion Freak Fest 2026', en: 'Fashion Freak Fest 2026 appearance' }, image: '/assets/adonisg/media/appearance-04.webp' },
  { name: 'Televisión', title: { es: 'Aparición en set de televisión', en: 'Television appearance' }, image: '/assets/adonisg/media/appearance-05.webp' },
  { name: 'El Janis', title: { es: 'Crédito como asesor de imagen', en: 'Image consultant credit' }, image: '/assets/adonisg/media/appearance-06.webp' },
  { name: 'Gran Bazar', title: { es: 'Conferencia de etiqueta personal y asesoría de imagen', en: 'Personal etiquette and image consulting conference' }, image: '/assets/adonisg/media/appearance-07.webp' },
  { name: 'Conferencista', title: { es: 'Participación como conferencista', en: 'Speaker appearance' }, image: '/assets/adonisg/media/appearance-08.webp' },
  { name: 'Editorial', title: { es: 'Publicación editorial destacada', en: 'Featured editorial publication' }, image: '/assets/adonisg/media/appearance-09.webp' }
]
...
const TESTIMONIALS: TestimonialItem[] = [
  { image: '/assets/adonisg/testimonials/brachy.webp', quote: { es: 'La asesoría logró que mi imagen se sintiera mucho más intencional, segura y alineada con lo que quería comunicar.', en: 'The consultation made my image feel much more intentional, confident and aligned with what I wanted to communicate.' }, by: { es: 'Brachy', en: 'Brachy' } },
  { image: '/assets/adonisg/testimonials/dr-hugo.webp', quote: { es: 'Gracias por siempre cuidar cada detalle y hacer que todo se vea con intención y elegancia.', en: 'Thank you for always caring for every detail and making everything look intentional and elegant.' }, by: { es: 'Dr. Hugo María', en: 'Dr. Hugo María' } },
  { image: '/assets/adonisg/testimonials/la-faisa.webp', quote: { es: 'El proceso me ayudó a proyectar una versión más fuerte, coherente y auténtica de mi presencia.', en: 'The process helped me project a stronger, more coherent and authentic version of my presence.' }, by: { es: 'La Faisa', en: 'La Faisa' } },
  { image: '/assets/adonisg/testimonials/viuda-blanca.webp', quote: { es: 'Cada detalle del styling aportó intención y carácter sin perder mi propia esencia.', en: 'Every styling detail added intention and character without losing my own essence.' }, by: { es: 'Viuda Blanca', en: 'Viuda Blanca' } }
]
...
export default function IntapProfileAdonisgV1({ profile }: { profile: IntapProfileV2Profile }) {
  ...
  useEffect(() => {
    ...
    meta('description', description); meta('og:title', title, true); meta('og:description', description, true); meta('og:type', 'profile', true); meta('og:url', canonical, true); meta('og:image', `${origin}/assets/adonisg/og/adonisg-og-v2.jpg`, true); meta('twitter:card', 'summary_large_image'); meta('twitter:title', title); meta('twitter:description', description); meta('twitter:image', `${origin}/assets/adonisg/og/adonisg-og-v2.jpg`)
