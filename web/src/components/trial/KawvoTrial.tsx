...
export default function KawvoTrial({mode}:{mode:Mode}){
  ...
  return <>
    ...
    {crop&&<TrialImageCrop file={crop.file} aspectRatio={crop.kind==='hero'?16/7:crop.kind==='avatar'?1:4/3} outputWidth={crop.kind==='hero'?1280:crop.kind==='avatar'?640:960} onCancel={()=>{setCrop(null);setCropIndex(null);setServiceCropIndex(null)}} onSave={async file=>{await upload(crop.kind,file);setCrop(null)}}/>}
