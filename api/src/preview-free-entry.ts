...
import './sponsored-scan'
import './scan-status'
import './scan-to-claim'
import './artifact-controls'
import './sponsored-public'
import './sponsored-admin-safe-assign'
import './sponsored-code-generation'
import './sponsored-consent-claim'
import './sponsored-owner-flow'
import './sponsored-brand-controls'
...
import './team-code-delete'
import './team-join-authority'
import './team-v2'
import './team-name'
import './team-browser-authority'
