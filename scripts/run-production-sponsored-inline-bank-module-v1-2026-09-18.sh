...
cat <<EOF
============================================================
KAWVO LINK · CUENTAS BANCARIAS INLINE · PRODUCCIÓN
============================================================
- integra cuentas bancarias dentro del editor patrocinado
- aplica tanto a beneficiario como a perfil Master
- reutiliza endpoints patrocinados existentes
- conserva máximo 3 cuentas
- permite agregar, editar y eliminar dentro de la misma sección
- integra Cuentas bancarias al recorrido guiado
- elimina dependencia del botón flotante Configurar cuentas
- NO modifica Free/Plus/Team
- NO toca API, D1, migraciones ni Web pública
- despliega solamente App
============================================================
...
ALLOWED='^(app/src/App\.tsx|app/src/components/admin/sponsored/SponsoredBankAccounts\.tsx|app/src/components/admin/sponsored/SponsoredDashboard\.tsx|app/src/components/admin/sponsored/SponsorDashboard\.tsx|app/src/components/admin/sponsored/SponsoredGuidedTour\.tsx|scripts/test-sponsored-profile-contract\.mjs|scripts/run-production-sponsored-inline-bank-module-v1-2026-09-18\.sh)$'
...
TAG="prod-sponsored-inline-bank-module-v1-2026-09-18-$(date +%H%M%S)"
run git tag -a "$TAG" -m "Sponsored inline bank module V1 production 2026-09-18"
...
cat <<EOF
============================================================
✓ CUENTAS BANCARIAS INLINE DESPLEGADAS EN PRODUCCIÓN
============================================================
