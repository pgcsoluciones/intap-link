    ...
    <main className="min-h-screen bg-[#f7f9fc] px-5 py-8 font-['Inter'] text-slate-950">
      <section className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-[430px] flex-col justify-center">
        <div className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-[0_18px_55px_rgba(15,23,42,0.08)]">
          <p className="text-[11px] font-black uppercase tracking-[0.22em] text-cyan-600">Todo listo para empezar</p>
          ...
          <div className="mt-5 rounded-2xl bg-slate-50 p-4">
            ...
            <div className="mt-3 space-y-3 text-sm text-slate-600">
              <p><strong className="text-slate-900">1.</strong> Elige tu rubro y la subcategoría más cercana.</p>
              <p><strong className="text-slate-900">2.</strong> Cuéntanos cómo conociste Kawvo.</p>
              <p><strong className="text-slate-900">3.</strong> Nuestros asistentes prepararán tu perfil base.</p>
            </div>
          </div>

          <p className="mt-4 text-xs leading-5 text-slate-400">Luego podrás cambiar los textos, imágenes y datos por los tuyos. Te iremos guiando hasta que esté listo para publicar.</p>
