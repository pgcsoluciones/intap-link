...
BRANCH="feature/kawlink-trial-online-v1"
WEB_PROJECT="intap-link"
APP_PROJECT="intap-web2"
PREVIEW_DB="intap_db_preview"
LOG_DIR="$ROOT/.preview-kawlink-trial-online-v1-logs"
...
cat <<'EOF'
============================================================
KAWVO LINK · TRIAL ONLINE V1 · PREVIEW
============================================================
- NO toca Producción
- NO hace merge a main
- despliega rama feature/kawlink-trial-online-v1
...
run bash -lc 'npx esbuild api/src/preview-free-entry.ts --bundle --platform=node --format=esm --target=node20 --external:cloudflare:* --outfile=/tmp/kawvo-trial-online-preview-api.mjs'
run bash -lc 'npx esbuild api/src/preview-frontdoor-entry.ts --bundle --platform=node --format=esm --target=node20 --external:cloudflare:* --outfile=/tmp/kawvo-trial-online-preview-frontdoor.mjs'
...
code="$(curl -sS -o "$LOG_DIR/owner.json" -w '%{http_code}' https://app.preview.intaprd.com/api/v1/me/trials/online)"
[ "$code" = "401" ] || fail "Owner Trial sin sesión debe responder 401, respondió $code"
echo "✓ Seguridad owner: endpoint privado bloqueado sin sesión"
...
cat <<EOF
============================================================
✓ TRIAL ONLINE V1 DESPLEGADO EN PREVIEW
============================================================
Feature SHA: $(git rev-parse HEAD)
Web: https://preview.intaprd.com/trial
App: https://app.preview.intaprd.com
