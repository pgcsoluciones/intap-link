...
grep -Fq 'aria-label="Mi cuenta"' app/src/components/admin/free/FreeDashboard.tsx || fail "Mi cuenta no está en la barra superior"
! grep -Fq "title: 'Mi cuenta'" app/src/components/admin/free/FreeDashboard.tsx || fail "Mi cuenta sigue duplicada dentro de las tarjetas del panel"
...
grep -Fq 'Marcar como leída' app/src/components/admin/free/FreeNotificationBell.tsx || fail "Falta marcar notificación como leída desde detalle"
...
grep -Fq 'Enviar cuentas bancarias' app/src/components/admin/free/FreeAccount.tsx || fail "Cuentas bancarias no está orientado a compartir enlace"
...
if ! git diff --cached --quiet; then
  run git commit -m "feat(account): refine account center navigation"
...
echo ""
echo "QA FÍSICO:"
echo "1) Barra superior: campana + Mi cuenta; no debe aparecer Salir."
echo "2) Servicios y Portafolio: botón Editar textos."
echo "3) Mi cuenta: Cerrar sesión dentro del panel; cuentas bancarias comparte enlace y no configura."
echo "4) Notificaciones: una sola bandeja; abrir detalle, marcar como leída y eliminar."
echo "5) Mi cuenta: plan, IA, QR, banco si aplica, invitar, dispositivos, recursos, ayuda/tickets, productos y eliminación."
echo "6) SuperAdmin Recursos: crear/editar/ocultar/eliminar un recurso de prueba."
echo "============================================================"
