...
LOG_DIR="$ROOT/.preview-no-profile-activation-entry-v1-logs"
...
cat <<'EOF'
============================================================
KAWVO LINK · CUENTA SIN PERFIL · NUEVA ENTRADA DE ACTIVACIÓN
PREVIEW V1
============================================================
- elimina la pantalla legacy que pedía códigos
- ofrece activar dispositivo / adquirir dispositivo / cerrar sesión
- activación guía por NFC o QR
...
if echo "$CHANGED" | grep -Eq '^(api/src/|web/src/|functions/)'; then
  fail "Hay cambios fuera del Admin App"
fi
...
cat <<EOF
============================================================
✓ NUEVA ENTRADA CUENTA SIN PERFIL LISTA EN PREVIEW
============================================================
Feature SHA: $FEATURE_SHA
Prueba iniciando sesión con una cuenta sin perfil:
https://app.preview.intaprd.com/admin/free/onboarding/welcome

Validar:
- Ya tengo un dispositivo Kawvo
- No tengo dispositivo, pero me interesa
- Cerrar sesión
- Pantalla de activación por NFC / QR
