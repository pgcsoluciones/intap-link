...
export default function KawvoTrial({mode}:{mode:Mode}){
  ...
  function closePublished(){
    ...
    setPublished(null)
    setQr('')
    window.location.assign(url||'/trial')
  }
  function createAnotherTrial(){
    setPublished(null)
    setQr('')
    window.location.assign('/trial?new=1')
  }
