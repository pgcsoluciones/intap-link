...
LOG_DIR="$ROOT/.production-kawlink-trial-postpublish-flow-logs"
...
cat <<'EOF'
============================================================
KAWVO LINK · FLUJO POST-PUBLICACIÓN TRIAL · PRODUCCIÓN
============================================================
...
DIRTY="$(git status --porcelain | grep -v '^?? web/public/assets/welcome/' | grep -v '^?? .production-kawlink-trial-logs/' | grep -v '^?? .production-kawlink-trial-postpublish-flow-logs/' || true)"
...
cat <<EOF
============================================================
✓ FLUJO POST-PUBLICACIÓN TRIAL DESPLEGADO
============================================================
SHA: $LOCAL_SHA
