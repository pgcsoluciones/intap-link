...
import SponsoredBankAccounts, { SponsoredBankModuleLauncher } from './components/admin/sponsored/SponsoredBankAccounts'
...
<Route path="/admin/sponsored/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsor/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsored/activate" element={<SponsoredActivation/>}/><Route path="/admin/sponsored" element={<AdminGuard requireProfile={false}><><SponsoredExperienceTools/><SponsoredDashboard/><SponsoredBankModuleLauncher/><SponsoredGuidedTour/></></AdminGuard>}/><Route path="/admin/sponsored/bank-accounts" element={<AdminGuard requireProfile={false}><SponsoredBankAccounts/></AdminGuard>}/><Route path="/admin/sponsor" element={<AdminGuard requireProfile={false}><SponsorDashboard/></AdminGuard>}/>
