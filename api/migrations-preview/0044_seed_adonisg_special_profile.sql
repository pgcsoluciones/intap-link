...
VALUES (
  ...
  '{"role":"Asesor de Imagen · Estilista de Moda · Estratega de Marca","role_en":"Image Consultant · Fashion Stylist · Personal Brand Strategist","languages":{"default":"es","enabled":["es","en"]},"instagram_url":"https://www.instagram.com/argenisgrullonrd/","media_mentions_json":"[]","collaborations_json":"[{\"name\":\"Raquel Moreta\",\"role_es\":\"Colaboración editorial\",\"role_en\":\"Editorial collaboration\"},{\"name\":\"Lily Payamps\",\"role_es\":\"Colaboración editorial\",\"role_en\":\"Editorial collaboration\"},{\"name\":\"Lilibeth Durán\",\"role_es\":\"Colaboración editorial\",\"role_en\":\"Editorial collaboration\"},{\"name\":\"Todo Abrigos\",\"role_es\":\"Vestuario y moda\",\"role_en\":\"Wardrobe and fashion collaboration\"},{\"name\":\"Black Photos\",\"role_es\":\"Fotografía de moda\",\"role_en\":\"Fashion photography collaboration\"},{\"name\":\"Jeisly Blossom\",\"role_es\":\"Joyería\",\"role_en\":\"Jewelry collaboration\"}]"}',
  'esencial'
);
