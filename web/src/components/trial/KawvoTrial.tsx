...
export default function KawvoTrial({mode}:{mode:Mode}){
  ...
  if(loading)return <div className="trial-state">Cargando presentación…</div>
  if(error && !trial && mode!=='master')return <div className="trial-state"><h1>No pudimos abrir esta presentación</h1><p>{error}</p></div>
