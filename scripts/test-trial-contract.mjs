...
assert.ok(api.includes("page_size')||20"),'Trial analytics pagination backend missing')
...
assert.ok(superAdmin.includes('Página {analytics?.pagination?.page||1}'),'Trial analytics pagination missing')
