...
type DetailModal =
  | {
      kind: 'portfolio'
      item: FreeProfilePortfolioItem
    }
  | {
      kind: 'service'
      item: FreeProfileService
    }
  | null
...
function whatsappUrl(
  ...
  const message = subject
    ? (
      ...
      `vi "${subject}" en tu perfil de INTAP LINK ` +
      `y me gustaría recibir más información.`
    )
    : (
      `Hola ${profile.whatsappGreetingName}, ` +
      `vi tu perfil en INTAP LINK y me gustaría recibir más información.`
    )
...
export default function IntapLinkGratisProfile({
  ...
  const [linksOpen, setLinksOpen] =
    useState(false)

  const [modal, setModal] =
    useState<DetailModal>(null)


  // INTAP FREE · reset initial scroll
  useEffect(() => {
    window.scrollTo({
      top: 0,
      left: 0,
  ...
  const portfolio =
    profile.portfolio.slice(
      0,
      FREE_PROFILE_LIMITS.maxPortfolioImages,
    )

  const customLinks =
    profile.customLinks.slice(
      0,
  ...
  const webLink =
    useMemo(
      () =>
        customLinks.find(
          (link) =>
            /web|sitio|página|pagina|website/i
              .test(link.label),
        ) ?? null,
      [customLinks],
    )
  ...
  function downloadProfileQr() {
    ...
    link.href = qrDataUrl
    link.download =
      `${profile.slug || 'intap-link'}-qr.png`
  ...
  function shareProfileQrWhatsApp() {
    const message =
      `Conoce el perfil de ${profile.name} en INTAP LINK:\n${window.location.href}`
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title:
            `${profile.name} | INTAP LINK`,

          text:
            `Conoce el perfil de ${profile.name}`,
  ...
  return (
    <main
      className={`ilx-page ilx-layout-${layout}`}
      style={variables}
    >
      {topContent}
                  ...
                  {[
                    ...
                    (
                      ...
                      >
                        ...
                        <span className="ilx-portfolio-title">
                          {item.title}
                        </span>
                      </button>
                    ),
                  ...
                  (service) => (
                    ...
                    >
                      ...
                      <div className="ilx-service-copy">
                        ...
                        <span className="ilx-service-more">
                          Ver detalles
                        </span>
                      </div>
                    </button>
      ...
      {qrOpen && (
        ...
        >
          <article
            className="ilx-qr-modal"
            role="dialog"
            aria-modal="true"
            aria-labelledby="ilx-qr-title"
          >
            <button
              type="button"
              className="ilx-modal-close"
            ...
            <div className="ilx-qr-modal-body">
              ...
              <p>
                Escanea para abrir este perfil.
              </p>
              ...
              <strong className="ilx-qr-profile-name">
                {profile.name}
              </strong>
              ...
              <div className="ilx-qr-actions">
                ...
                <button
                  type="button"
                  className="ilx-qr-whatsapp"
                  onClick={shareProfileQrWhatsApp}
                >
                  <FaWhatsapp />
                  <span>
          ...
          >
            ...
            <div className="ilx-modal-media">
              ...
              'portfolio' ? (
                ...
                <span className="ilx-modal-service-icon">
                  {serviceIcon(
                    modal.item.iconKey,
                  )}
                </span>
