...
<Route path="/admin/free/home" element={<AdminGuard planScope="free"><FreePwaHome/></AdminGuard>}/><Route path="/admin/free/account" element={<AdminGuard planScope="free"><FreeAccount/></AdminGuard>}/><Route path="/admin/free/notifications" element={<AdminGuard planScope="free"><FreeNotifications/></AdminGuard>}/><Route path="/admin/free/team" element={<AdminGuard planScope="free"><FreeTeamCorporate/></AdminGuard>}/><Route path="/admin/free/team/assign" element={<AdminGuard requireProfile={false} planScope="free"><FreeTeamAssign/></AdminGuard>}/><Route path="/admin/free/team/member-edit" element={<AdminGuard requireProfile={false} planScope="free"><FreeTeamMemberEdit/></AdminGuard>}/><Route path="/admin/free/team/member" element={<AdminGuard requireProfile={false} planScope="free"><FreeTeamMember/></AdminGuard>}/><Route path="/admin/free/team/join" element={<AdminGuard requireProfile={false} planScope="free"><FreeTeamJoin/></AdminGuard>}/><Route path="/admin/free" element={<AdminGuard planScope="free"><FreeDashboard/></AdminGuard>}/>
