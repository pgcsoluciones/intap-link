...
export default function IntapProfileAdonisgV1({ profile }: { profile: IntapProfileV2Profile }) {
  ...
  useEffect(() => {
    ...
    meta('description', description); meta('og:title', title, true); meta('og:description', description, true); meta('og:type', 'profile', true); meta('og:url', canonical, true); meta('og:image', `${origin}/assets/adonisg/og/adonisg-og-v6.png?v=20260911-r2-v2`, true); meta('twitter:card', 'summary_large_image'); meta('twitter:title', title); meta('twitter:description', description); meta('twitter:image', `${origin}/assets/adonisg/og/adonisg-og-v6.png?v=20260911-r2-v2`)
