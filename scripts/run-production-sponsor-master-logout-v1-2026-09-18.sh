...
BRANCH="hotfix/sponsor-master-logout-v1"
EXPECTED_MAIN_SHA="86a94a90296e7be2343d35dfd1f0addef0b93627"
APPROVED_PRODUCT_SHA="b40f596adbf7520e608f09de37675eb5f24391f4"
RUNNER_PATH="scripts/run-production-sponsor-master-logout-v1-2026-09-18.sh"
APP_PROJECT="intap-web2"
LOG_DIR="$ROOT/.production-sponsor-master-logout-v1-logs"
...
cat <<EOF
============================================================
KAWVO LINK · CERRAR SESIÓN MASTER · PRODUCCIÓN
============================================================
- solo modifica SponsorDashboard.tsx
- no toca API, D1, Web pública ni migraciones
- no cambia Free, Plus, Team, Med ni beneficiario patrocinado
- compila App antes del deploy
- smoke login + panel sponsor
...
[ "$DIFF_FILES" = "app/src/components/admin/sponsored/SponsorDashboard.tsx" ] || { echo "$DIFF_FILES"; fail "El hotfix contiene archivos fuera del alcance"; }
...
TAG="prod-sponsor-master-logout-v1-2026-09-18-$(date +%H%M%S)"
run git tag -a "$TAG" -m "Sponsor Master logout V1 production 2026-09-18"
...
cat <<EOF
============================================================
✓ CERRAR SESIÓN MASTER DESPLEGADO EN PRODUCCIÓN
============================================================
