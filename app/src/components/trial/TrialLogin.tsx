  ...
  return <main className="min-h-screen bg-[#f7f9fc] px-5 py-8 font-['Inter'] text-slate-950">
    <section className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-[430px] flex-col justify-center">
      <div className="mb-7 text-center">
        <p className="text-[11px] font-black uppercase tracking-[0.22em] text-cyan-600">KAWLINK TRIAL · 4 DÍAS GRATIS</p>
      ...
      <div className="rounded-[28px] border border-slate-200 bg-white p-2 shadow-[0_18px_55px_rgba(15,23,42,0.08)]">
        ...
        <div className="p-4 pt-5">
          ...
          <p className="mt-5 text-center text-xs leading-5 text-slate-400">Tu prueba Full comienza cuando completamos la activación de tu Trial. Tendrás 4 días completos para personalizar y compartir tu presentación.</p>
        </div>
      </div>
    </section>
  </main>
