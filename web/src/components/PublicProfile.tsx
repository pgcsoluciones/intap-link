...
export default function PublicProfile() {
  ...
  // Ninguna plantilla pública se rescata por slug.
  // Todo perfil debe existir en API/D1 y declarar su templateId.
  ...
  const registeredTemplate = renderRegisteredProfileTemplate(
    data.templateId,
    publicProfileV2,
  )
