...
const PROJECTS: Project[] = [
  { id: 'beauty-fragrance', title: { es: 'Belleza y fragancia', en: 'Beauty & Fragrance' }, category: { es: 'Estilismo editorial', en: 'Editorial styling' }, cover: '/assets/adonisg/portfolio/beauty-fragrance/beauty-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/beauty-fragrance/beauty-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/beauty-fragrance/beauty-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/beauty-fragrance/beauty-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/beauty-fragrance/beauty-04.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/beauty-fragrance/beauty-05.webp?v=20260911-r2-v2'], description: { es: 'Producción editorial donde belleza, fragancia, accesorios y composición construyen una narrativa visual elegante y coherente.', en: 'An editorial production where beauty, fragrance, accessories and composition build an elegant, coherent visual story.' } },
  { id: 'red-statement', title: { es: 'Declaración en rojo', en: 'Red Statement' }, category: { es: 'Editorial de moda', en: 'Fashion editorial' }, cover: '/assets/adonisg/portfolio/red-statement/red-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/red-statement/red-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/red-statement/red-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/red-statement/red-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/red-statement/red-04.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/red-statement/red-05.webp?v=20260911-r2-v2'], description: { es: 'Color, silueta y actitud se unen para construir una presencia fuerte, elegante y memorable.', en: 'Color, silhouette and attitude unite to build a strong, elegant and memorable presence.' } },
  { id: 'noir', title: { es: 'Noir', en: 'Noir' }, category: { es: 'Editorial de moda', en: 'Fashion editorial' }, cover: '/assets/adonisg/portfolio/noir/noir-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/noir/noir-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/noir/noir-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/noir/noir-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/noir/noir-04.webp?v=20260911-r2-v2'], description: { es: 'Una narrativa oscura y sofisticada construida desde volumen, accesorios, detalle y presencia.', en: 'A dark sophisticated narrative built through volume, accessories, detail and presence.' } },
  { id: 'couple', title: { es: 'Pareja y estilo de vida', en: 'Couple Lifestyle' }, category: { es: 'Estilismo de estilo de vida', en: 'Lifestyle styling' }, cover: '/assets/adonisg/portfolio/couple-lifestyle/couple-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/couple-lifestyle/couple-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/couple-lifestyle/couple-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/couple-lifestyle/couple-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/couple-lifestyle/couple-04.webp?v=20260911-r2-v2'], description: { es: 'Una historia visual donde vestuario, entorno y conexión trabajan como una sola composición.', en: 'A visual story where wardrobe, setting and connection work as one composition.' } },
  { id: 'evening', title: { es: 'Presencia de noche', en: 'Evening Statement' }, category: { es: 'Estilismo de gala', en: 'Evening styling' }, cover: '/assets/adonisg/portfolio/evening/evening-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/evening/evening-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/evening/evening-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/evening/evening-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/evening/evening-04.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/evening/evening-05.webp?v=20260911-r2-v2'], description: { es: 'Silueta, color y accesorios diseñados para elevar seguridad, ocasión e impacto.', en: 'Silhouette, color and accessories designed to elevate confidence, occasion and impact.' } },
  { id: 'mens-brand', title: { es: 'Imagen masculina y marca personal', en: 'Mens Image & Personal Brand' }, category: { es: 'Marca personal', en: 'Personal branding' }, cover: '/assets/adonisg/portfolio/mens-brand/mens-cover.webp?v=20260911-r2-v2', images: ['/assets/adonisg/portfolio/mens-brand/mens-cover.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/mens-brand/mens-02.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/mens-brand/mens-03.webp?v=20260911-r2-v2','/assets/adonisg/portfolio/mens-brand/mens-04.webp?v=20260911-r2-v2'], description: { es: 'Estilismo masculino orientado a presencia, coherencia y posicionamiento.', en: 'Mens styling focused on presence, coherence and positioning.' } }
]

const MEDIA: MediaItem[] = [
  { name: 'Mes de la Belleza', title: { es: 'Campaña retail y presencia de marca', en: 'Retail campaign and brand presence' }, image: '/assets/adonisg/media/appearance-01.webp?v=20260911-r2-v2' },
  { name: 'DMH · DLB Noticias', title: { es: 'Lo Que No Te Cuentan del Éxito', en: 'Lo Que No Te Cuentan del Éxito' }, image: '/assets/adonisg/media/appearance-02.webp?v=20260911-r2-v2' },
  { name: 'Gran Bazar de Emprendedores', title: { es: 'Potencializa tu imagen en redes sociales', en: 'Elevate your image on social media' }, image: '/assets/adonisg/media/appearance-03.webp?v=20260911-r2-v2' },
  { name: 'Fashion Freak Fest', title: { es: 'Presencia en Fashion Freak Fest 2026', en: 'Fashion Freak Fest 2026 appearance' }, image: '/assets/adonisg/media/appearance-04.webp?v=20260911-r2-v2' },
  { name: 'Televisión', title: { es: 'Aparición en set de televisión', en: 'Television appearance' }, image: '/assets/adonisg/media/appearance-05.webp?v=20260911-r2-v2' },
  { name: 'El Janis', title: { es: 'Crédito como asesor de imagen', en: 'Image consultant credit' }, image: '/assets/adonisg/media/appearance-06.webp?v=20260911-r2-v2' },
  { name: 'Gran Bazar', title: { es: 'Conferencia de etiqueta personal y asesoría de imagen', en: 'Personal etiquette and image consulting conference' }, image: '/assets/adonisg/media/appearance-07.webp?v=20260911-r2-v2' },
  { name: 'Conferencista', title: { es: 'Participación como conferencista', en: 'Speaker appearance' }, image: '/assets/adonisg/media/appearance-08.webp?v=20260911-r2-v2' },
  { name: 'Editorial', title: { es: 'Publicación editorial destacada', en: 'Featured editorial publication' }, image: '/assets/adonisg/media/appearance-09.webp?v=20260911-r2-v2' }
]
...
const FAQS: FaqItem[] = [
  ...
  { q: { es: '¿Qué incluye el servicio?', en: 'What is included in the service?' }, a: { es: 'Según el objetivo, puede incluir análisis de colorimetría, estudio de silueta y rostro, definición de estilo personal, revisión de guardarropa, guía de compras inteligentes y recomendaciones de proyección y actitud.', en: 'Depending on the goal, it may include color analysis, body and face assessment, style definition, wardrobe review, shopping guidance and presence recommendations.' } },
  { q: { es: '¿La asesoría incluye acompañamiento de compras?', en: 'Can the consultation include personal shopping?' }, a: { es: 'Sí, si así lo deseas. Puede realizarse de forma presencial acompañándote en tiendas o de manera virtual con opciones, enlaces y sugerencias ajustadas a tu perfil, ubicación y presupuesto.', en: 'Yes. It can be done in person in stores or virtually with options tailored to your profile, location and budget.' } },
  { q: { es: '¿Cuánto dura la asesoría?', en: 'How long does a consultation take?' }, a: { es: 'Una asesoría puede durar entre 1 y 2 horas, dependiendo del tipo de servicio y de los objetivos definidos para la sesión.', en: 'A consultation may last between 1 and 2 hours depending on the service and goals.' } },
  { q: { es: '¿Trabajas con hombres y mujeres?', en: 'Do you work with men and women?' }, a: { es: 'Sí. Cada proceso se construye alrededor de la persona, su contexto, su estilo de vida y lo que necesita proyectar.', en: 'Yes. Each process is built around the person, context, lifestyle and what they need to project.' } },
  { q: { es: '¿Las asesorías pueden ser virtuales o presenciales?', en: 'Can consultations be virtual or in person?' }, a: { es: 'Sí. La modalidad se define según el servicio. Algunas sesiones pueden realizarse virtualmente y otras de manera presencial en Santiago o según coordinación previa.', en: 'Yes. Some sessions can be virtual and others in person in Santiago or by prior arrangement.' } }
]

const TESTIMONIALS: TestimonialItem[] = [
  { image: '/assets/adonisg/testimonials/brachy.webp?v=20260911-r2-v2', quote: { es: 'La asesoría logró que mi imagen se sintiera mucho más intencional, segura y alineada con lo que quería comunicar.', en: 'The consultation made my image feel much more intentional, confident and aligned with what I wanted to communicate.' }, by: { es: 'Brachy', en: 'Brachy' } },
  { image: '/assets/adonisg/testimonials/dr-hugo.webp?v=20260911-r2-v2', quote: { es: 'Gracias por siempre cuidar cada detalle y hacer que todo se vea con intención y elegancia.', en: 'Thank you for always caring for every detail and making everything look intentional and elegant.' }, by: { es: 'Dr. Hugo María', en: 'Dr. Hugo María' } },
  { image: '/assets/adonisg/testimonials/la-faisa.webp?v=20260911-r2-v2', quote: { es: 'El proceso me ayudó a proyectar una versión más fuerte, coherente y auténtica de mi presencia.', en: 'The process helped me project a stronger, more coherent and authentic version of my presence.' }, by: { es: 'La Faisa', en: 'La Faisa' } },
  { image: '/assets/adonisg/testimonials/viuda-blanca.webp?v=20260911-r2-v2', quote: { es: 'Cada detalle del styling aportó intención y carácter sin perder mi propia esencia.', en: 'Every styling detail added intention and character without losing my own essence.' }, by: { es: 'Viuda Blanca', en: 'Viuda Blanca' } }
]

const PORTRAITS = Array.from({ length: 13 }, (_, i) => `/assets/adonisg/portraits/behind-${String(i + 1).padStart(2, '0')}.webp`)
...
const VIDEOS = ['/assets/adonisg/videos/video-01.mp4?v=20260911-r2-v2', '/assets/adonisg/videos/video-02.mp4?v=20260911-r2-v2', '/assets/adonisg/videos/video-03.mp4?v=20260911-r2-v2']
...
function ModalShell({ children, onClose, label, wide = false }: { children: ReactNode; onClose: () => void; label: string; wide?: boolean }) {
  ...
  return <div className="adonis-modal-backdrop" role="dialog" aria-modal="true" aria-label={label} onMouseDown={e => e.target === e.currentTarget && onClose()}><div className={`adonis-modal${wide ? ' is-wide' : ''}`}><button className="adonis-modal-close" onClick={onClose} aria-label="Cerrar"><FaTimes /></button>{children}</div></div>
}

function FixedMedia({ src, alt }: { src: string; alt: string }) {
  return <div className="adonis-fixed-media" style={{ '--media': `url("${src}")` } as React.CSSProperties}><img src={src} alt={alt} /></div>
}
...
export default function IntapProfileAdonisgV1({ profile }: { profile: IntapProfileV2Profile }) {
  ...
  useEffect(() => { const id = window.setInterval(() => setHeroSlide(v => (v + 1) % HERO_SLIDES.length), 4600); return () => clearInterval(id) }, [])
  useEffect(() => { const id = window.setInterval(() => setPortfolioSlide(v => (v + 1) % PROJECTS.length), 5200); return () => clearInterval(id) }, [])
  useEffect(() => { if (!activeProject) return; const id = window.setInterval(() => setGalleryIndex(v => (v + 1) % activeProject.images.length), 4200); return () => clearInterval(id) }, [activeProject])
  useEffect(() => { if (!portraitOpen) return; const id = window.setInterval(() => setPortraitIndex(v => (v + 1) % PORTRAITS.length), 4200); return () => clearInterval(id) }, [portraitOpen])
  useEffect(() => { const id = window.setInterval(() => setMediaSlide(v => (v + 1) % MEDIA.length), 5600); return () => clearInterval(id) }, [])
  ...
  useEffect(() => {
    ...
    meta('description', description); meta('og:title', title, true); meta('og:description', description, true); meta('og:type', 'profile', true); meta('og:url', canonical, true); meta('og:image', `${origin}/assets/adonisg/og/adonisg-og-v5.jpg?v=20260911-r2-v2`, true); meta('twitter:card', 'summary_large_image'); meta('twitter:title', title); meta('twitter:description', description); meta('twitter:image', `${origin}/assets/adonisg/og/adonisg-og-v5.jpg?v=20260911-r2-v2`)
  ...
  return <main className="adonis-profile">
    <header className="adonis-hero">
      ...
      <nav className="adonis-topbar"><span className="adonis-top-logo-wrap"><img src="/assets/adonisg/brand/logo-white.png?v=20260911-r2-v2" alt="Al Estilo de Argenis" /></span><button className="adonis-language" onClick={() => setLanguage(language === 'es' ? 'en' : 'es')}><FaGlobeAmericas /> {language === 'es' ? 'English' : 'Español'}</button></nav>
    ...
    <section className="adonis-brand-strip"><img src="/assets/adonisg/brand/logo-black-transparent-v2.png?v=20260911-r2-v2" alt="Al Estilo de Argenis" /></section>
    ...
    <section className="adonis-expertise"><h2>{t.expertise}</h2><div className="adonis-marquee"><div>{[...t.runner, ...t.runner].map((item, i) => <span key={`${item}-${i}`}>{item}</span>)}</div></div></section>

    <section className="adonis-portfolio" id="portfolio">
      <h2>{t.portfolio}</h2>
      ...
      <button className="adonis-btn adonis-btn-outline adonis-all-projects" onClick={() => setProjectPortalOpen(true)}>{t.allProjects} <FaArrowRight /></button>
    </section>

    <section className="adonis-testimonials">
      <h2>{t.testimonials}</h2>
      <div className={`adonis-testimonial-stage${testimonialOpen ? ' is-paused' : ''}`}><div className="adonis-testimonial-runner">{[...TESTIMONIALS, ...TESTIMONIALS].map((item, i) => <button key={`${item.by.es}-${i}`} className="adonis-testimonial-card" onClick={() => setTestimonialOpen(item)}><img src={item.image} alt={item.by[language]} /><span>{item.by[language]}</span></button>)}</div></div>
    </section>

    <section className="adonis-personal"><h2>{t.portraits}</h2><button className="adonis-personal-card" onClick={() => { setPortraitIndex(0); setPortraitOpen(true) }}><FixedMedia src={PORTRAITS[0]} alt={displayName} /><p>{t.portraitsCopy}</p><span className="adonis-btn adonis-btn-dark">{t.gallery} <FaArrowRight /></span></button></section>

    <section className="adonis-media"><h2>{t.media}</h2><button className="adonis-media-card" onClick={() => setActiveMedia(featuredMedia)}><FixedMedia src={featuredMedia.image} alt={featuredMedia.name} /><div><small>{featuredMedia.name}</small><h3>{featuredMedia.title[language]}</h3><span>{t.mediaDetail} <FaArrowRight /></span></div></button><div className="adonis-slider-dots adonis-slider-dots-light">{MEDIA.map((_, i) => <button key={i} className={i === mediaSlide ? 'is-active' : ''} onClick={() => setMediaSlide(i)} aria-label={`${t.media} ${i + 1}`} />)}</div></section>
    ...
    <section className="adonis-platform"><img src="/assets/adonisg/brand/logo-white.png?v=20260911-r2-v2" alt="Al Estilo de Argenis" /><h2>{t.platformTitle}</h2><p>{t.platformCopy}</p></section>
    ...
    <section className="adonis-brand-footer"><img src="/assets/adonisg/brand/footer-banner.png?v=20260911-r2-v2" alt="Al Estilo de Argenis" /></section>
