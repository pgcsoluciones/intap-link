...
run python3 scripts/apply-demo-ai-integration-v1_2.py
run git diff --check
...
run git add \
  ...
  scripts/apply-demo-ai-integration-v1_2.py \
...
- cooldown, límite por sesión/IP y presupuesto diario con fallback.
