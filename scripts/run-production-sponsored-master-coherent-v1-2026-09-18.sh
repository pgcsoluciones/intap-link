...
BRANCH="release/sponsored-master-coherent-v1"
EXPECTED_MAIN_SHA="db40799a07e3eb15a5c5cb7765cbf3b7a38e1ce7"
APPROVED_PRODUCT_SHA="65192b07f4547ab9956f86dc33517ff49c000c6b"
RUNNER_PATH="scripts/run-production-sponsored-master-coherent-v1-2026-09-18.sh"
APP_PROJECT="intap-web2"
LOG_DIR="$ROOT/.production-sponsored-master-coherent-v1-logs"
...
cat <<EOF
============================================================
KAWVO LINK · RELEASE COHERENTE MASTER + BANCOS · PRODUCCIÓN
============================================================
- rama limpia nacida de main actual
- Master resuelve únicamente sponsor_owner
- beneficiario excluye sponsor_owner
- GET Master crea/rellena base antes de responder
- starter, edición, publicación, imágenes y bancos respetan scope
- cuentas bancarias están dentro del editor, no en launcher separado
- recorrido incluye cuentas bancarias
- Free/Plus/Team fuera del alcance
...
ALLOWED='^(api/src/sponsored-profile-scope\.ts|api/src/sponsored-profiles\.ts|api/src/sponsored-starter\.ts|api/src/sponsored-media\.ts|api/src/sponsored-bank-accounts\.ts|app/src/App\.tsx|app/src/components/admin/sponsored/SponsorDashboard\.tsx|app/src/components/admin/sponsored/SponsoredBankAccounts\.tsx|app/src/components/admin/sponsored/SponsoredDashboard\.tsx|app/src/components/admin/sponsored/SponsoredGuidedTour\.tsx|app/src/components/admin/sponsored/SponsoredStarterOnboarding\.tsx|scripts/test-sponsored-profile-contract\.mjs|scripts/run-production-sponsored-master-coherent-v1-2026-09-18\.sh)$'
...
run npx esbuild api/src/preview-free-entry.ts --bundle --platform=node --format=esm --target=node20 --external:cloudflare:* --outfile=/tmp/kawvo-sponsored-master-coherent-api.mjs
...
TAG="prod-sponsored-master-coherent-v1-2026-09-18-$(date +%H%M%S)"
run git tag -a "$TAG" -m "Sponsored Master coherent V1 production 2026-09-18"
...
cat <<EOF
============================================================
✓ RELEASE COHERENTE MASTER + BANCOS EN PRODUCCIÓN
============================================================
