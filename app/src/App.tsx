...
<Route path="/admin/sponsored/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsor/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsored/activate" element={<SponsoredActivation/>}/><Route path="/admin/sponsored" element={<AdminGuard requireProfile={false}><SponsoredDashboard/></AdminGuard>}/><Route path="/admin/sponsor" element={<AdminGuard requireProfile={false}><SponsorDashboard/></AdminGuard>}/>
