...
import FreeTeamGuidedTour from './FreeTeamGuidedTour'
...
export default function FreeTeamCorporate(){
  ...
  return <main className="min-h-screen bg-[#f7f9fc] font-['Inter'] text-slate-950"><div className="mx-auto w-full max-w-[980px] px-5 pb-24 pt-5">
    <div data-team-tour="header" className="sticky top-0 z-30 -mx-5 border-b border-slate-200/80 bg-[#f7f9fc]/95 px-5 py-3 backdrop-blur">
