...
assert.match(apiSource, /replace_services_confirmation_required/, 'Replacing existing services must require explicit confirmation')
...
assert.match(appSource, /replaceServices/, 'UI must expose replacement confirmation for existing services')
