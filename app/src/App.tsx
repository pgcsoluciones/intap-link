...
import TrialLogin from './components/trial/TrialLogin'
import TrialCheckEmail from './components/trial/TrialCheckEmail'
import TrialActivate from './components/trial/TrialActivate'
...
import SuperAdminTrials from './components/admin/SuperAdminTrials'
...
import SuperAdminSponsorBrand from './components/admin/SuperAdminSponsorBrand'
...
import SponsoredAccessEntry from './components/admin/sponsored/SponsoredAccessEntry'
import SponsoredBankAccounts from './components/admin/sponsored/SponsoredBankAccounts'
import SponsoredGuidedTour from './components/admin/sponsored/SponsoredGuidedTour'
import SponsoredExperienceTools from './components/admin/sponsored/SponsoredExperienceTools'
import SponsoredProfileSelector from './components/admin/sponsored/SponsoredProfileSelector'
...
<Route path="/trial/login" element={<TrialLogin/>}/><Route path="/trial/check-email" element={<TrialCheckEmail/>}/><Route path="/trial/activate" element={<TrialActivate/>}/><Route path="/admin/login" element={<AdminLogin/>}/><Route path="/admin/check-email" element={<AdminVerify/>}/><Route path="/auth/callback" element={<AuthCallback/>}/><Route path="/team-access/:slug" element={<FreeTeamRoleLogin/>}/><Route path="/activate-product/:publicCode" element={<ActivationAuthorityEntry/>}/><Route path="/activate" element={<Navigate to="/admin/artifacts/activate" replace/>}/>
<Route path="/admin/sponsored/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsor/entry" element={<SponsoredAccessEntry/>}/><Route path="/admin/sponsored/activate" element={<SponsoredActivation/>}/><Route path="/admin/sponsored/select" element={<AdminGuard requireProfile={false}><SponsoredProfileSelector/></AdminGuard>}/><Route path="/admin/sponsored" element={<AdminGuard requireProfile={false}><><SponsoredExperienceTools/><SponsoredDashboard/><SponsoredGuidedTour/></></AdminGuard>}/><Route path="/admin/sponsored/bank-accounts" element={<AdminGuard requireProfile={false}><SponsoredBankAccounts/></AdminGuard>}/><Route path="/admin/sponsor" element={<AdminGuard requireProfile={false}><SponsorDashboard/></AdminGuard>}/>
...
<Route path="/superadmin" element={<SuperAdminGuard><SuperAdminDashboard/></SuperAdminGuard>}/><Route path="/superadmin/products" element={<SuperAdminGuard><SuperAdminArtifacts/></SuperAdminGuard>}/><Route path="/superadmin/sponsors" element={<SuperAdminGuard><SuperAdminSponsors/></SuperAdminGuard>}/><Route path="/superadmin/sponsors/brand" element={<SuperAdminGuard><SuperAdminSponsorBrand/></SuperAdminGuard>}/><Route path="/superadmin/support" element={<SuperAdminGuard><SuperAdminSupport/></SuperAdminGuard>}/><Route path="/superadmin/resources" element={<SuperAdminGuard><SuperAdminResources/></SuperAdminGuard>}/><Route path="/superadmin/feedback" element={<SuperAdminGuard><SuperAdminFeedback/></SuperAdminGuard>}/><Route path="/superadmin/demo" element={<SuperAdminGuard><SuperAdminDemoMetrics/></SuperAdminGuard>}/><Route path="/superadmin/trials" element={<SuperAdminGuard><SuperAdminTrials/></SuperAdminGuard>}/><Route path="/superadmin/promotions" element={<SuperAdminGuard><SuperAdminPromotions/></SuperAdminGuard>}/>
