...
export default function SponsoredExperienceTools(){
  ...
  return <>
    <div className="fixed bottom-5 left-5 z-40 flex max-w-[calc(100vw-2.5rem)] flex-wrap gap-2 rounded-2xl border border-slate-200 bg-white/95 p-2 shadow-xl backdrop-blur">
      ...
      <button type="button" onClick={()=>void openAccount()} className="rounded-xl px-3 py-2 text-xs font-black text-slate-700">Mi cuenta</button>
