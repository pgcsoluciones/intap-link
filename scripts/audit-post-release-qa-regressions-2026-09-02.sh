...
check "$MW" 'function profileShareImage' 'Falta resolución explícita de imagen social del perfil'
...
check "$MW" "'hasOfferCatalog'" 'SEO dinámico no expone catálogo de servicios'
