  ...
  return (
    <main className="min-h-screen bg-[#f7f9fc] px-5 py-5 font-['Inter'] text-slate-950">
      <section className="mx-auto w-full max-w-[430px] py-1">
        ...
        <p className="mt-2 text-[15px] leading-6 text-slate-500">Actualiza tus datos principales. Los números dominicanos 809, 829 y 849 se guardan automáticamente con +1.</p>
