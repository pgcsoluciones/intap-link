...
BRANCH="feature/sponsored-bank-order-v1"
EXPECTED_MAIN_SHA="e4a302501ffa8e422adea3371753aa37815a5f2f"
APPROVED_PRODUCT_SHA="d0eb43db77b588b52051c50d1dee7ffcc09cd8c2"
WEB_PROJECT="intap-link"
APP_PROJECT="intap-web2"
LOG_DIR="$ROOT/.production-sponsored-bank-order-v1-logs"
...
cat <<EOF
============================================================
KAWVO LINK · ORDEN PATROCINADO · PRODUCCIÓN
============================================================
Orden aprobado:
1. Nuestro horario
2. Cuentas bancarias
3. Galería / Catálogo
4. resto del flujo patrocinado sin cambios

- aplica en panel editor y perfil público
- evita render bancario duplicado fuera del perfil
- NO toca D1
...
POST_FILES="$(git diff --name-only "$APPROVED_PRODUCT_SHA"..HEAD | grep -Ev '^scripts/run-production-sponsored-bank-order-v1-2026-09-19\.sh$' || true)"
...
ALLOWED='^(app/src/components/admin/sponsored/SponsoredDashboard\.tsx|web/src/(App\.tsx|components/sponsored/SponsoredProfile\.tsx)|scripts/test-sponsored-profile-contract\.mjs|scripts/run-production-sponsored-bank-order-v1-2026-09-19\.sh)$'
...
TAG="prod-sponsored-bank-order-v1-2026-09-19-$(date +%H%M%S)"
run git tag -a "$TAG" -m "Sponsored bank order V1 production 2026-09-19"
...
cat <<EOF
============================================================
✓ ORDEN PATROCINADO DESPLEGADO EN PRODUCCIÓN
============================================================
