...
const PLUS_PLAN_URL = 'https://nfc.kawvoia.com/plan-basico'
const PLUS_PLAN_PHONE = '18097059802'
const PLUS_TRIAL_MESSAGE = 'Tengo un perfil Digital Gratis y quiero probar el Plan Plus por 7 días gratis.'

export function basicPlanWhatsAppUrl() {
  return PLUS_PLAN_URL
}

export function basicTrialWhatsAppUrl() {
  return `https://wa.me/${PLUS_PLAN_PHONE}?text=${encodeURIComponent(PLUS_TRIAL_MESSAGE)}`
}

export function UpgradeCrownIcon({ className = 'h-6 w-6' }: { className?: string }) {
  return (
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 text-sm font-medium leading-6 text-slate-700">Logra mayor impacto con más herramientas en tu perfil. Pásate al Plan Plus.</p>
          <a
