...
-- Producción: inventario persistente de recursos gráficos de perfiles especiales.
-- Los binarios viven en R2; D1 conserva el mapa lógico -> r2_key y metadatos.
...
SET template_data = json_set(
      ...
      '$.social_image_url', 'https://api.intaprd.com/api/v1/public/profiles/argenisg/assets/og/adonisg-og-v2.jpg'
    ),
